...
transTopDef x = case x of
  ...
  AbsLatte.ClDef _ ident classext clmembers -> failure x

transClassExt :: Show a => AbsLatte.ClassExt' a -> Result
transClassExt x = case x of
  AbsLatte.NoExt _ -> failure x
  AbsLatte.Ext _ ident -> failure x

transClMember :: Show a => AbsLatte.ClMember' a -> Result
transClMember x = case x of
  AbsLatte.Attr _ type_ ident -> failure x
  AbsLatte.Meth _ type_ ident args block -> failure x
...
transExpr x = case x of
  ...
  AbsLatte.EArrElem _ expr1 expr2 -> failure x
  AbsLatte.EClassVar _ expr ident -> failure x
  AbsLatte.EMethCall _ expr ident exprs -> failure x
  AbsLatte.EApp _ ident exprs -> failure x
  AbsLatte.EInitArr _ type_ expr -> failure x

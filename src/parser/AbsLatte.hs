...
data TopDef' a
    ...
    | ClDef a Ident (ClassExt' a) [ClMember' a]
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)

type ClassExt = ClassExt' BNFC'Position
data ClassExt' a = NoExt a | Ext a Ident
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)

type ClMember = ClMember' BNFC'Position
data ClMember' a
    = Attr a (Type' a) Ident
    | Meth a (Type' a) Ident [Arg' a] (Block' a)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)
...
data Expr' a
    = EVar a Ident
    | EArrElem a (Expr' a) (Expr' a)
    | EClassVar a (Expr' a) Ident
    | EMethCall a (Expr' a) Ident [Expr' a]
    | EApp a Ident [Expr' a]
    | EInitArr a (Type' a) (Expr' a)
    | ENewCls a (Type' a)
    | ECastNull a (Type' a)
    | ELitInt a Integer
    | ELitTrue a

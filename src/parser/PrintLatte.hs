...
instance Print (AbsLatte.TopDef' a) where
  prt i = \case
    ...
    AbsLatte.ClDef _ id_ classext clmembers -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id_, prt 0 classext, doc (showString "{"), prt 0 clmembers, doc (showString "}")])
...
instance Print (AbsLatte.ClassExt' a) where
  prt i = \case
    AbsLatte.NoExt _ -> prPrec i 0 (concatD [])
    AbsLatte.Ext _ id_ -> prPrec i 0 (concatD [doc (showString "extends"), prt 0 id_])

instance Print (AbsLatte.ClMember' a) where
  prt i = \case
    AbsLatte.Attr _ type_ id_ -> prPrec i 0 (concatD [prt 0 type_, prt 0 id_, doc (showString ";")])
    AbsLatte.Meth _ type_ id_ args block -> prPrec i 0 (concatD [prt 0 type_, prt 0 id_, doc (showString "("), prt 0 args, doc (showString ")"), prt 0 block])
...
instance Print (AbsLatte.Stmt' a) where
  prt i = \case
    ...
    AbsLatte.Ass _ expr1 expr2 -> prPrec i 0 (concatD [prt 8 expr1, doc (showString "="), prt 0 expr2, doc (showString ";")])
    AbsLatte.Incr _ expr -> prPrec i 0 (concatD [prt 8 expr, doc (showString "++"), doc (showString ";")])
    AbsLatte.Decr _ expr -> prPrec i 0 (concatD [prt 8 expr, doc (showString "--"), doc (showString ";")])
...
instance Print (AbsLatte.Expr' a) where
  prt i = \case
    ...
    AbsLatte.EArrElem _ expr1 expr2 -> prPrec i 8 (concatD [prt 7 expr1, doc (showString "["), prt 0 expr2, doc (showString "]")])
    AbsLatte.EClassVar _ expr id_ -> prPrec i 8 (concatD [prt 7 expr, doc (showString "."), prt 0 id_])
    AbsLatte.EMethCall _ expr id_ exprs -> prPrec i 7 (concatD [prt 7 expr, doc (showString "."), prt 0 id_, doc (showString "("), prt 0 exprs, doc (showString ")")])
    AbsLatte.EApp _ id_ exprs -> prPrec i 7 (concatD [prt 0 id_, doc (showString "("), prt 0 exprs, doc (showString ")")])
    AbsLatte.EInitArr _ type_ expr -> prPrec i 7 (concatD [doc (showString "new"), prt 0 type_, doc (showString "["), prt 0 expr, doc (showString "]")])
    AbsLatte.ENewCls _ type_ -> prPrec i 7 (concatD [doc (showString "new"), prt 0 type_])
